...
/// <summary>
/// Integration tests against the native library, using the built-in
/// synthetic test device so no physical hardware is required.
/// </summary>
/// <remarks>
/// The whole class is skipped when the native library could not be loaded,
/// so the suite still passes on hosts that have not built the C library yet.
/// </remarks>
