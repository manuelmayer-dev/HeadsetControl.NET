...
// ---------------------------------------------------------------------------
//  HeadsetControl.NET sample
//
//  Discovers connected headsets, prints their identity and capabilities, and
//  reads battery & chat-mix state where supported.  Pass --test to include
//  the synthetic test device built into the native library.
// ---------------------------------------------------------------------------
